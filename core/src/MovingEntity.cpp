...
// Getters
const Direction& MovingEntity::getFacing() const
{
	return m_facing;
}
...
const sf::Vector2f& MovingEntity::getMovement() const
{
	return m_movement;
}

const WalkingState& MovingEntity::getWalkingState() const
{
	return m_walkingState;
}

const yState& MovingEntity::getYState() const
{
	return m_yState;
}

// Setters
void MovingEntity::setFacing(const Direction& facing)
{
	m_facing = facing;
}
...
void MovingEntity::setWalkingState(const WalkingState& walkingState)
{
...
void MovingEntity::setYState(const yState& state)
{
	if (    state == m_yState 						||
...
void MovingEntity::setClimbingDirection(const Direction& direction)
{
